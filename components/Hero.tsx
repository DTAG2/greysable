    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        <div className="mb-8 animate-fade-in">
          <span className="text-xs font-medium uppercase tracking-[0.3em] text-grey-500">
        ...
        <div className="animate-fade-in animation-delay-100">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[0.9] uppercase">
            Precision
            <br />
            <span className="text-grey-500">Systems</span>
            <br />
            Built to Last
          </h1>
        </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-start gap-4 animate-fade-in animation-delay-300">
          <Link
            href="/contact"
            className="group px-8 py-4 bg-white text-black font-medium uppercase tracking-wider text-sm hover:bg-grey-200 transition-colors duration-150"
          >
            Start Project
          ...
          <Link
            href="/about"
            className="px-8 py-4 border border-grey-700 text-white font-medium uppercase tracking-wider text-sm hover:bg-grey-900 hover:border-grey-600 transition-colors duration-150"
          >
            Learn More
          </Link>
        </div>
      ...
      {/* Bottom accent */}
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-grey-700 to-transparent" />

      {/* Corner accents */}
      <div className="absolute bottom-8 left-8 flex flex-col gap-1">
        <div className="w-8 h-px bg-grey-700" />
        <div className="w-4 h-px bg-grey-800" />
      </div>
